              ...
              <div class="lg:col-span-2">
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                  ...
                  <div wire:ignore class="mt-2 md:col-span-3">
                    <label class="mb-[5px]" for="user_id">انتخاب دسته بندی</label>
                    <select wire:model="category" id="select2-dropdown"  class="cat-list h-10 border rounded px-4 w-full bg-gray-50">
                  ...
                  <div wire:ignore class="md:col-span-6">
                    <label for="email">توضیحات مقاله</label>
                    <textarea  wire:model="body" id="body" name="body" class="border mt-4 rounded p-4 w-full bg-gray-50" value="" placeholder="توضیحات خود را بنویسید ...." ></textarea>
                    @error('body')
                    {{$message}}
                   @enderror
                  </div>
                  ...
                  <div class="md:col-span-6 text-left">
                    <div class="inline-flex items-end">
                      <button wire:click.prevent="store()" class="w-40 bg-gradient-to-tr from-primary-500 to-[#00abc7] hover:from-[#00abc7] hover:to-primary-500 text-white font-bold py-2 px-6 rounded">انتشار محتوا</button>
                    </div>
                  </div>
