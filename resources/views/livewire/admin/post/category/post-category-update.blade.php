                  ...
                  <label class="w-64 m-auto flex justify-center items-center py-1.5 rounded-md tracking-wide uppercase ursor-pointer text-gray ease-linear transition-all duration-150">
                      <svg class=" h-10 w-10 text-[#00b9c0]" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                        ...
                        <div class="flex flex-col">
                          <span class="mt-2 text-base leading-normal">آپلود تصویر دسته بندی</span>
              ...
              <div class="lg:col-span-2">
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                  ...
                  <div class="md:col-span-3">
                    ...
                    <input wire:model="slug" type="text" name="slug" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                    @error('slug')
                    {{$message}}
                    @enderror
                  </div>
                  ...
                  <div class="md:col-span-6">
                    ...
                    <textarea  wire:model="description"  name="text" class="border mt-4 rounded p-4 w-full bg-gray-50" value="" placeholder="email@domain.com" ></textarea>
                    @error('text')
                    {{$message}}
                   @enderror
                  </div>
