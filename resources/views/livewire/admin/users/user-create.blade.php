        ...
        <div>
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
              <div class="text-gray-600">
               ...
               <div id="holder" class="relative user-profile flex flex-col items-center m-auto w-[150px] h-[150px]">
                  @if (empty($image))
              ...
              <div class="lg:col-span-2">
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-6">
                  <div class="md:col-span-2">
                    ...
                    <input wire:model="first_name" type="text" name="first_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                    @error('first_name')
                    {{$message}}
                    @enderror
                  </div>
                  <div class="md:col-span-2">
                    ...
                    <input wire:model="last_name" type="text" name="last_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                    @error('last_name')
                    {{$message}}
                    @enderror
                  </div>
                  ...
                  <div class="md:col-span-3">
                      ...
                      <select wire:model="role_id" name="role_id" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50">
                  ...
                  <div class="md:col-span-6 text-left">
                    <div class="inline-flex items-end">
                      <button wire:click.prevent="store()" class="w-40 bg-gradient-to-tr from-primary-500 to-[#00abc7] hover:from-[#00abc7] hover:to-primary-500 text-white font-bold py-2 px-6 rounded">ثبت کاربر</button>
                    </div>
                  </div>
