        ...
        <div>
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-2">
              ...
              <div class="lg:col-span-2">
                ...
                <div  class="mt-2 md:col-span-2" wire:key="select-field-model-version-{{ $iteration }}">
                  <div wire:ignore>
                    ...
                    <select wire:model="parent_id" id="select2-dropdown"  class="emails-list h-10 border rounded px-4 w-full bg-gray-50">
                      <option value="null" selected>بدون والد</option>
                  ...
                  <div class="md:col-span-6 text-left">
                    <div class="inline-flex items-end">
                      <button wire:click.prevent="store()" class="w-40 bg-gradient-to-tr from-primary-500 to-[#00abc7] hover:from-[#00abc7] hover:to-primary-500 text-white font-bold py-2 px-6 rounded">افزودن منو</button>
                    </div>
                  </div>
