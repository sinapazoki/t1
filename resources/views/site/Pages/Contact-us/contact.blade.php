    ...
    <div class="absolute top-0 w-full h-full bg-left sm:bg-center bg-cover" >
      <span id="blackOverlay" class="w-full h-full absolute bg-gray-200">
        ...
        <div class="md:top-1/4 text-[#071623] bg-white sm:bg-inherit text-white p-4 sm:p-0 rounded-lg ">
            <h1 class="text-2xl md:text-4xl">ارتباط با ما</h1>
            <div class="breadcrumbs">
              ...
              <span property="itemListElement" typeof="ListItem">
                ...
                <meta property="position" content="1"></span> 
                  ...
                  <span property="name">ارتباط با ما</span>
                </a>
              </div>
...
<section class="bg-white py-20 px-4 lg:py-[50px] md:overflow-hidden md:relative md:z-10">
  <div class="max-w-7xl mx-auto">
     <div class="flex flex-wrap lg:justify-between -mx-4 items-center">
        <div class="w-full lg:w-1/2 xl:w-6/12 px-4 bg-[url('/storage/admin-image/contact-map.png')] bg-no-repeat bg-contain bg-center">
           <div class="max-w-[570px] mr-auto mb-12 lg:mb-0">
              <span class="block mb-4 text-base text-primary font-semibold">
              راه های ارتباطی با شرکت تی وان
              </span>
              <h2 class=" text-primary-800 mb-6 uppercase font-bold text-xl md:text-2xl">
                 پیام شما می‌تواند شروع یک مکالمۀ سازنده باشد!
              </h2>
              <div class="mydivider text-right"><div class="divider-inner"></div></div>
                <div class="flex mb-8 max-w-[370px] w-full">
                 ...
                 <div class="w-full">
                    <h4 class="font-bold  text-xl mb-1">آدرس دفتر مرکزی</h4>
              ...
              <div class="flex mb-8 max-w-[370px] w-full">
                 ...
                 <div class="w-full">
                    <h4 class="font-bold text-dark text-xl mb-1">شماره تماس</h4>
                    <p class="text-base text-body-color">0912-1234567</p>
                 </div>
              </div>
              <div class="flex mb-8 max-w-[370px] w-full">
                 <div
           ...
           {{-- <div class="overflow-hidden">
            <iframe class="mr-auto" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3242.4854177066854!2d51.472129699999996!3d35.6404103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3f91fc5616b8f001%3A0xaeda31a2e5b89c98!2sTehran%20Province%2C%20Tehran%2C%20District%2015%2C%20Morteza%20Motahhari%20St%2C%20Iran!5e0!3m2!1sen!2suk!4v1658044384766!5m2!1sen!2suk" width="570" height="150" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div> --}}
        </div>
           ...
           <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
              <form action="{{route('site.contact-form')}}" method="post">
               ...
               @enderror
                 ...
                 <div>
                  <button type="submit" class=" w-full btn btn-wide">ارسال پیام</button>
