...
<div class="relative h-screen w-full flex items-center justify-center bg-cover bg-center text-center px-5" style="background-image:url(https://images.pexels.com/photos/260689/pexels-photo-260689.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500);">
    ...
    <div class="grid grid-cols-4 gap-10 text-center mx-auto mt-[30px] sm:mt-10">
      ...
      @livewire('emailnotifyform')

      
      {{-- <div class="mt-6 flex text-white mx-auto">
           <a href="/#">
              <svg fill="currentColor" class="cursor-pointer h-10 mr-2" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule: evenodd; clip-rule: evenodd; stroke-linejoin: round; stroke-miterlimit: 2;">
